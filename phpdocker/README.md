...
------|---------|-----------
php-fpm|sfgraph-php-fpm|9000
MySQL|sfgraph-mysql|3306 (default)
...
**Note 2:** if you're using Vagrant, you'll need to ssh into it first
  ...
  * Execute command inside of container: `docker exec -it sfgraph-php-fpm COMMAND` where `COMMAND` is whatever you want to run. For instance, `/bin/bash` to open a console prompt.
